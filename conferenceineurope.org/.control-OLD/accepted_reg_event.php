...
include("fun.php");
$sql_new_ev="SELECT * FROM `event` WHERE `status`='Accept' order by `event_id` Asc";
 $_SESSION['ev_status']="Accept";
?>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="80%" align="center" valign="top"><table width="100%" height="129" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="37" align="center" class="inner_welcome">Accepted Event Details </td>
          </tr>
          ...
          <tr>
            ...
            <?php include("load_data_event.php"); ?>
