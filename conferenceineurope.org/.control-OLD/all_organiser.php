...
<script language="javascript" src="js/organiser_pagi.js"></script>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="80%" align="center" valign="top"><table width="100%" height="129" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="94%" height="37" align="center" class="inner_welcome">All Organiser  Details </td>
            <td width="6%" align="center" class="inner_welcome"><a href="all_org_excel.php"><img src="images/Excel-icon.png" width="30" height="30" border="0" /></a></td>
          </tr>
          
          <tr>
            <td colspan="2">
            
            <?php include("load_organiser_data.php"); ?>            </td>
          </tr>
        </table></td>
      </tr>
    </table></td>
