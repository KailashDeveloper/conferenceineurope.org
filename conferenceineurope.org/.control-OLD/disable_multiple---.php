...
<form name="staus" id="staus" method="post" action="up_status_multiple_disable.php" onSubmit="">
  ...
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="3">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td height="20" colspan="3" align="center"  class="inner_welcome">Disable Events </td>
      ...
      <tr>
        ...
        <td colspan="4" align="left" class="table_sub_content"><span class="table_content" style="width:400px; height:100px; overflow:auto"><?php echo $ev_id_list; ?></span></td>
