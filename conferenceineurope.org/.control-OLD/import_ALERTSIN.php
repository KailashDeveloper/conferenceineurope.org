...
<input type="hidden" name="keywords" id="keywords" value="<?php  echo $new_ev_data['keywords']; ?>" >
     ...
     <div id="load_journal_det" >Import Status</</div>
			
				<script language="javascript">
				function set_status(event_id,list_id)
				{
			
				$.get("update_import_detail.php",{event_id:event_id,list_id:list_id},function(d){$("#load_journal_det").html(d)}); 	
               ...
               <script>
					...
					setTimeout(10000);
						set_status(<?php echo $event_id; ?>,3);
					})
				</script>               
