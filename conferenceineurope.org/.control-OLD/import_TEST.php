...
$sql_last_import_detail=mysqli_fetch_array(mysqli_query($link,"SELECT * FROM `import_detail` where `id` = '1'"));
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" id="import_tabb">
           ...
           <tr class="<?php echo $class; ?>">
                <td colspan="2" align="center">
                  ...
                  <input type="checkbox" name="content1[]" class="ads_Checkbox" value="reload" checked>                </td>
                <td align="center">&nbsp;</td>
                ...
                <td align="center" class="dt">&nbsp;</td>
                <td align="center">&nbsp;</td>
                <td width="7%" align="center"><a href="javascript:void(0);"  name="reload" id="ln_reload" class="link" onclick="details_all(this.name);"><div id="ln_reload">View</div></a></td>
                <td width="7%" align="center" id="IMP_reload">
				<div>
				
				
				
				
				<form name="MULTI_reload" id="MULTI_reload" action="" method="post"  onsubmit="window.location.reload();">
				
								<input type="submit" name="" id="reload"   value="IMPORT" />
				</form>
				</div>
				<div id="rep_reload"></div>
				</td>
              </tr>
			  
			    <tr>
                <td colspan="13"> <div id="det_reload"></div>                </td>
                </tr>
...
and (`event`.`event_stat` > curdate() and `event`.`event_id` > '$last_import_id' ) and `event`.`org_id` ='1'   order by `event`.`event_id` ASC limit 0,3";
		...
		$class="tab_bg1";
              ...
              <tr class="<?php echo $class; ?>">
                <td colspan="2" align="center">
                  ...
                  <input type="checkbox" name="content1[]" class="ads_Checkbox" value="<?php echo  $new_ev_data['event_id']; ?>" checked>                </td>
