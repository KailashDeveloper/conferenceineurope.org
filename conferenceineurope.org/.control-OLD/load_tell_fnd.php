...
$query_pag_data = "SELECT * FROM `tell_fnd` ORDER BY `tell_id` DESC LIMIT $start, $per_page";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">        
      <tr>
                ...
                <td width="29%" align="center" class="tab_header1">Description</td>

                <td width="13%" align="center" class="tab_header1">Shared To</td>
			 ...
			 // $sql_new_ev="SELECT * FROM `event` WHERE `status`='pending' order by `event_id` Asc";
              ...
              <tr class="<?php echo $class; ?>">
				...
				<hr>
				<?php echo $place; ?>
				<hr>				<span style="font-size:12px"><?php echo $event_date; ?></span></td>

         
                <td align="center"  ><a href="<?php echo $host_url; ?>" target="_blank"><?php echo $host_url; ?></a></td>

                <td align="center" style="font-size:12px"><?php echo $short_desc; ?></td>
                ...
                <td colspan="9"> <div id="det_<?php  echo $new_ev_data['event_id']; ?>"></div>                </td>
...
//$query_pag_num = "SELECT COUNT(*) AS count FROM event WHERE `status`='$ev_status'";
 ...
 $query_pag_num ="SELECT * FROM `tell_fnd` ORDER BY `tell_id` DESC";
