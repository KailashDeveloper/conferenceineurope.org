      ...
      <tr>
        ...
        <td colspan="2" align="left"><label>
          ...
          <select name="promote_type" class="form_list" id="promote_type">
            ...
            <option value="HOMEPROMOTE">HOMEPROMOTE</option>
            <option value="PAGEPROMOTE">PAGEPROMOTE</option>
      ...
      <tr>
        ...
        <td colspan="2" align="left"><label>
          ...
          <select name="promote_place" class="form_list" id="promote_place">
            ...
            <option value="conference.html">conference.html</option>
            <option value="webinar.html">webinar.html</option>
            <option value="international-conference.html">international-conference.html</option>
            <option value="upcoming-conferences.html">upcoming-conferences.html</option>
