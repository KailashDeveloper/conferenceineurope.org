...
if(isset($_REQUEST['delete_id']))
	{
	 ...
	 $sql_delete="Update `group_promote` set `status` ='Hide' WHERE `group_id` ='$delete_id' ";
...
$j=0;
              ...
              <tr class="<?php echo $class; ?>" style="padding:5px;">
                ...
                <td width="8%" align="center"><a href="view_group_add.php?delete_id=<?php echo $new_ev_data['group_id']; ?>" class="link" >Delete</a>&nbsp;</td>
