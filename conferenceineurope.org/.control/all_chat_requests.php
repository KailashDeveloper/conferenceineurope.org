...
<script language="javascript" src="js/chat_page.js"></script>

<script language="javascript">
	function chat_commets(id,email)	
	{
	$.get('commets_manage.php',{ch_id:id,email:email},function(d){$('#light').html(d);});
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="80%" align="center" valign="top"><table width="100%" height="129" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="97%" height="37" align="center" class="inner_welcome">All Chat  Details </td>
            <td width="3%" align="center" class="inner_welcome"><a href="all_subsc_excel.php"><img src="images/Excel-icon.png" width="30" height="30" border="0" /></a></td>
          </tr>
          
          <tr>
            <td colspan="2">
            
            <?php include("load_chat_data.php"); ?>            </td>
          </tr>
        </table></td>
      </tr>
    </table></td>
