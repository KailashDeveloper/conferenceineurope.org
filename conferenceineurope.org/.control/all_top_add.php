          ...
          <tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td width="25%" align="center" class="tab_header1">Image</td>

                <td width="27%" align="center" class="tab_header1">Heading</td>
			 ...
			 $sql_new_ev="SELECT * FROM `ad_image` WHERE `ad_type`='Top' ORDER BY `id`  DESC";
              ...
              <tr class="<?php echo $class; ?>" style="padding:5px;">
                ...
                <td align="center"><img src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/ad/<?php echo  $new_ev_data['image']; ?>" style="width:150px" /></td>

                <td align="center"><?php echo  $new_ev_data['hed']; ?></td>

                <td align="center"><?php echo $new_ev_data['url']; ?></td>

                <td width="9%" align="center"><a href="all_top_add.php?delete_id=<?php echo $new_ev_data['id']; ?>" class="link" >Delete</a>&nbsp;</td>
