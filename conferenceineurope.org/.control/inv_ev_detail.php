...
<legend class="leg_hed">&nbsp;&nbsp;Organizer Detail&nbsp;&nbsp;&nbsp;&nbsp;</legend>
	...
	<table width="100%" border="0" cellspacing="2" cellpadding="0">
      ...
      <tr>
        ...
        <td class="table_sub_content"><span id="topicHeading">Organizer Status </span></td>

        <td>&nbsp;</td>

        <td class="table_content"><?php echo  $sql_ev_org_det['status']; ?></td>
...
<legend class="leg_hed">&nbsp;&nbsp;Event Datail &nbsp;&nbsp;&nbsp;</legend>
	...
	<table width="100%" border="0" cellspacing="2" cellpadding="0">
      ...
      <tr bgcolor="#FFFFFF" class="tab">
        <td class="table_sub_content"><span id="topicHeading2">Venue </span></td>
        <td>&nbsp;</td>
        <td class="table_content"><?php echo  $sql_ev_inv['venue']; ?></td>
      </tr>
      <tr bgcolor="#FFFFFF" class="tab">
