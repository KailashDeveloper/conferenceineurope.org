...
(`event`.`status`='$ev_status' and `event`.`event_stat`>=now())
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
			 ...
			 // $sql_new_ev="SELECT * FROM `event` WHERE `status`='pending' order by `event_id` Asc";
              ...
              <tr class="<?php echo $class; ?>">
                ...
                <td align="center">
                <a href="https://www.conferenceineurope.org/conf-detail.php?ev_id=<?php echo $new_ev_data['event_id']; ?>&name=<?php echo $new_ev_data['event_name']; ?>" target="_blank">
				...
				<strong style="color:#FF6600">Country-<?php echo event_country($new_ev_data[5]); ?></strong>
				...
				State - <?php echo $new_ev_data[6]; ?><br />



				<hr />

				City - <?php echo $new_ev_data[7]; ?>				</td>
                ...
                <td width="3%" align="center"><a href="javascript:void(0);" id="<?php  echo $new_ev_data['event_id']; ?>" class="link" onclick="manage(this.id)">Manage</a></td>

                <td width="4%" align="center"><a href="adm_event_edit.php?ev_id=<?php  echo $new_ev_data['event_id']; ?>" target="_blank">Edit</a></td>
                ...
                <td colspan="14"> <div id="det_<?php  echo $new_ev_data['event_id']; ?>"></div>                </td>
...
(`org_detail`.`status`='Accept' or `org_detail`.`org_id`<'926')";
