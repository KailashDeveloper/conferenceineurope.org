...
$query_pag_data = "SELECT * FROM `subscribe` WHERE (`status`='Accept' || `status`='')   order by `subc_id` Desc LIMIT $start, $per_page";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td width="16%" align="center" class="tab_header1">Organization </td>

                <td width="10%" align="center" class="tab_header1">Designation</td>

                <td width="14%" align="center" class="tab_header1">County/State/City</td>

                <td width="9%" align="center" class="tab_header1">Intrest</td>
			 ...
			 // $sql_new_ev="SELECT * FROM `event` WHERE `status`='pending' order by `event_id` Asc";
              ...
              <tr class="<?php echo $class; ?>" style="padding:5px;">
                ...
                <td height="29" align="center"><?php echo $new_ev_data['subc_id']; ?></td>

                <td align="center"><?php echo  $new_ev_data['name']; ?></td>

                <td align="center"><?php echo  $new_ev_data['email_id']; ?></td>

                <td align="center"><?php echo $new_ev_data['unv_org']; ?></td>

                <td align="center"><?php echo $new_ev_data['designation']; ?></td>

                <td align="left">

				  <strong class="goto">Country-></strong><?php echo event_country($new_ev_data['country']); ?><br />				 

					<strong class="goto">State-></strong><?php echo $new_ev_data['state']; ?><br />

					 <strong class="goto">City-></strong><?php echo $new_ev_data['city']; ?><br />
                ...
                <td width="6%" align="center"><?php echo $new_ev_data['status']; ?></td>
...
$query_pag_num = "SELECT COUNT(*) AS count FROM subscribe WHERE (`status`='Accept' || `status`='') ";
