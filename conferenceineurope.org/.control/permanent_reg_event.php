...
include("fun.php");
 $sql_new_ev="SELECT * FROM `event` WHERE `status`='Permanent Reject' order by `event_id` Asc";
 $_SESSION['ev_status']="Permanent Reject";
?>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td width="80%" align="center" valign="top"><table width="100%" height="129" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td height="37" align="center" class="inner_welcome">Permanent Reject Event Details </td>
          </tr>
