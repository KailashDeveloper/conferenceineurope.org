...
for($o=1;$o<sizeof($t_ev_id_list);$o++)
	...
	$sql_upss="UPDATE `event` SET `status` = '$status', `reason` = '$reason' WHERE `event_id` ='$ext_ev_id';";	
	mysqli_query($link,$sql_upss);
...
$conference_url = "https://www.conferencealerts.in/Event-Detail.php?EV-id=$ext_ev_id";
