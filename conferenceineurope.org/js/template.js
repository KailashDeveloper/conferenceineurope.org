    ...
    var Unifato = {
        ...
        enableShoppingWidget: function () {
            ...
            $el.each(function () {
                ...
                $removeBtn.on('click', function () {
                    ...
                    if (!lists.length)
                        $miniCartView.addClass('product_list_empty');
        ...
        enableShopSingleTabs: function () {
            try {
                ...
                if (wooTabs === null || wooTabs.length === 0)
                    return;
                _.each(wooTabs, function (wooTab) {
                    ...
                    if (activeListItem === null || activeListItem === 0)
                        return;
                    else {
